...
Feedstock license: [BSD-3-Clause](https://github.com/AnacondaRecipes/medspacy/blob/main/LICENSE.txt)
...
`medspacy` can be installed with:
...
Updating medspacy-feedstock
========================

If you would like to improve the medspacy recipe or build a new
